package com.one.boot.config;

import cn.hutool.captcha.generator.CodeGenerator;
import cn.hutool.core.collection.CollectionUtil;
import com.one.boot.common.constant.SecurityConstants;
import com.one.boot.config.property.SecurityProperties;
import com.one.boot.core.filter.RateLimiterFilter;
import com.one.boot.core.security.exception.MyAccessDeniedHandler;
import com.one.boot.core.security.exception.MyAuthenticationEntryPoint;
import com.one.boot.core.security.filter.CaptchaValidationFilter;
import com.one.boot.core.security.filter.JwtValidationFilter;
import com.one.boot.common.constant.SecurityConstants;
import com.one.boot.config.property.SecurityProperties;
import com.one.boot.core.filter.RateLimiterFilter;
import com.one.boot.core.security.exception.MyAccessDeniedHandler;
