package com.one.boot.shared.file.service.impl;
...
import com.one.boot.shared.file.service.FileService;
import com.one.boot.system.model.dto.FileInfo;
import io.minio.*;
    ...
    public boolean deleteFile(String filePath) {
        ...
        try {
            ...
            if (StrUtil.isNotBlank(customDomain)) {
                // https://oss.aliyun.com/default/20221120/test.jpg → 20221120/websocket.jpg
