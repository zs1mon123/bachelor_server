package com.one.boot.core.aspect;
...
public class LogAspect {
    ...
    @Pointcut("@annotation(com.one.boot.common.annotation.Log)")
    public void logPointcut() {
    }

    @Around("logPointcut() && @annotation(logAnnotation)")
    public Object logExecutionTime(ProceedingJoinPoint joinPoint, com.one.boot.common.annotation.Log logAnnotation) throws Throwable {
